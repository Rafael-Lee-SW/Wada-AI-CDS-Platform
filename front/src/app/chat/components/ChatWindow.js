...
export default function Home() {
    ...
    return (
        <div style={styles.mainContainer}>
            ...
            {page === 'fileUploader' && <FileUploader onChangePage={handleFileUpload}/>}
            {page === 'requirementUploader' && <RequirementUploader onChangePage={handlePageChange}/>} 

...
public class PromptGenerator {
        ...
        return String.format("""
            ...
            3. Available Models:
             ...
             \s
                    ...
                    "model_recommendations": [
                        {
                            ...
                            "implementation_request": {
                               ...
                               \s
                                // Required for supervised learning models (random_forest_regression, random_forest_classification, logistic_regression_binary, logistic_regression_multinomial, neural_network_regression):
                                "target_variable": "target_column_name",

                               // Required For some models to identify each target (random_forest_regression, random_forest_classification, graph_neural_network_analysis, neural_network_regression)
                ...
                - Include target_variable for all supervised learning models (random_forest_regression, random_forest_classification, logistic_regression_binary, logistic_regression_multinomial, neural_network_regression)
    ...
    public static String createSystemPromptForConversation(Map<String, Object> analysisContext) {
        return """
        {
            ...
            "Guidelines": [
                "If 'previous_QA_summary' is available, use it to ensure consistency with previous answers and avoid redundancy.",
                "If no prior questions exist, base your response only on 'analysis_results' and 'report_summary'."
            ],
            "Example": {
        ...
        return String.format("""
            {
                ...
                "Required Response Format": {
                    "answer": "Provide your detailed answer in Korean here with Markdown Format String, explaining the analysis results based on the question and context.",
                    "previous_QA_summary": "Provide a cumulative summary in English of all Q&A interactions so far, to retain context for future questions."
                }
            }
            """,

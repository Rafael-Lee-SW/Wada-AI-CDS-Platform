        ...
        return String.format(
            ...
            2. Available Models:
               ...
               3. logistic_regression_binary
                  ...
                  - Provides probability scores
                  - Required: feature_columns, target_variable
                  - Optional: binary_conditions[{ column, operator, value, target_column }]
                  - Example: Overpaid employee identification
               ...
               8. graph_neural_network_analysis
                  ...
                  - Optional: 
                    - additional_features
                    - feature_generations[{ type: "period", new_column: string, start_column: string, end_column: string }]
                  - Example: Organizational network analysis
               ```
            ...
            ```json
            {
                ...
                "other_reply": "Provide a detailed explanation or results summary based on the user’s current request. IN KOREAN",
                "post_interaction_summary": "If previous interactions contain this field, use it to inform your response; otherwise, generate a new summary based on the recent interactions."
            }
            ```
            """,
            newRequirement
